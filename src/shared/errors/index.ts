export const ERROR_CODES = {
  ...
  PLACE_FORBIDDEN: "PLACE_FORBIDDEN",
  ...
  IMAGE_REFERENCE_UNSUPPORTED: "IMAGE_REFERENCE_UNSUPPORTED",
  IMAGE_NO_FILES: "IMAGE_NO_FILES",
  ...
  ANNOUNCEMENT_SLUG_EXISTS: "ANNOUNCEMENT_SLUG_EXISTS",
} as const;
