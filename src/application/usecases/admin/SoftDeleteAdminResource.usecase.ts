import { SoftDeleteAdminResourceInput } from "@src/application/dtos/admin/softDeleteAdminResource.dto";
...
class SoftDeleteAdminResourceUseCase {
  constructor(
  ...
  async execute(params: SoftDeleteAdminResourceInput): Promise<void> {
...
export default SoftDeleteAdminResourceUseCase;
