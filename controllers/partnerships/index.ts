export { default as CreatePartnershipsController } from "./createPartnerships.controller";
export { default as UpdatePartnershipsController } from "./updatePartnerships.controller";
