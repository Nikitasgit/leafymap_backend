...
export interface GetUserEventsPartnershipsByUserIdInput {
  userId: string;
...
export interface IGetUserEventsPartnershipsByUserIdAction {
  execute(params: {
    filters: GetUserEventsPartnershipsByUserIdInput;
  }): Promise<IPartnership[]>;
}

class GetUserEventsPartnershipsByUserIdAction
  implements IGetUserEventsPartnershipsByUserIdAction
{
...
export default GetUserEventsPartnershipsByUserIdAction;
